...
class ExportSemanticPointCloud(Exporter):
    ...
    bounding_box_min: Tuple[float, float, float] =  (-1, -1, -1+.318) #(-1-x for x in [0.0908739572, 0.0752615010, -0.6810939259]) #(-1, -1, -1)
    """Minimum of the bounding box, used if use_bounding_box is True."""
    bounding_box_max: Tuple[float, float, float] = (1, 1, 1 +.318) #1-x for x in [0.0908739572, 0.0752615010, -0.6810939259]) #(1, 1, 1)
    """Maximum of the bounding box, used if use_bounding_box is True."""
    num_rays_per_batch: int = 512#32768//4#32768
    """Number of rays to evaluate per batch. Decrease if you run out of memory."""
    num_points_per_side: int = 3000
